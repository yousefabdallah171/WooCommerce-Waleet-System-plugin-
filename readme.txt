...
A powerful and extensible WooCommerce wallet system supporting payment, partial payment, cashback rewards program, and refunds for your WooCommerce store.

== Description ==

= Maximize Convenience and Savings: Wallet for WooCommerce Facilitates Quick Funds, Cashback, Refunds, and Partial Payments! =

Athar Wallet is an advanced digital wallet and credit system specially designed for WooCommerce. It empowers you to offer your customers a seamless payment experience by allowing them to deposit funds into their accounts, transfer money to other users, and make purchases using their wallet balance.

Beyond its core wallet functionality, Athar Wallet introduces an enticing cashback rewards system that enables you to provide discounts and rewards to your customers based on their purchases. You have the flexibility to set cashback rates for specific products or categories, and even offer bonus cashback during promotions or special events.

Athar Wallet puts you in control with extensive customization options. By implementing Athar Wallet, you can effortlessly enhance customer loyalty and drive repeat purchases through the attractive cashback rewards. Discover the power of Athar Wallet today and optimize your WooCommerce payment system for maximum efficiency!

= Use case of Athar Wallet =
...
> Experience the future of payments with Athar Wallet System!

= Workflow of Athar Wallet =
...
Now for enable cashback rules, navigate to Athar Wallet > Settings >  Credit. Now setup cashback rule according to your requirement. If cashback rule set to product wise then admin will have an option to add cashback rule for each product.
...
Coming soon! More features will be added to Athar Wallet System.

= Translator Contributors =

Translations welcome! Contact us at support@yousef-abdallah.online to contribute translations.
...
If you get stuck, you can email us at support@yousef-abdallah.online for assistance.

= Where can I report bugs or contribute to the project? =

Please report bugs and contributions at support@yousef-abdallah.online.

= Where can I find the REST API documentation? =

Visit https://yousef-abdallah.online for API documentation.

= This plugin is awesome! Can I contribute? =

Yes! Contact us at support@yousef-abdallah.online to contribute.
...
Changelog maintained by Athar Wallet System.
